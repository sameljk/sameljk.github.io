...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/blog/debate-23-bg" title="debate 23 bg" class="img-fluid rounded z-depth-1" style="width:100%; height: 50vw;"%}
    </div>
</div>
